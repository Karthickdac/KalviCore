...
function CourseDialog({ course, open, onOpenChange, trigger }: any) {
  ...
  const form = useForm({
    ...
    defaultValues: { name: course?.name || "", code: course?.code || "", departmentId: course?.departmentId || 0, duration: course?.duration || 4, degree: course?.degree || "B.E.", regulation: course?.regulation || "Regulation 2021", affiliatedUniversity: course?.affiliatedUniversity || "Anna University", totalSemesters: course?.totalSemesters || 8 },
  });
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              ...
              <FormField control={form.control} name="degree" render={({ field }) => (<FormItem><FormLabel>Degree *</FormLabel><Select onValueChange={field.onChange} value={field.value}><FormControl><SelectTrigger><SelectValue /></SelectTrigger></FormControl><SelectContent><SelectItem value="B.E.">B.E.</SelectItem><SelectItem value="B.Tech">B.Tech</SelectItem><SelectItem value="M.E.">M.E.</SelectItem><SelectItem value="M.Tech">M.Tech</SelectItem><SelectItem value="MBA">MBA</SelectItem><SelectItem value="MCA">MCA</SelectItem><SelectItem value="B.Sc">B.Sc</SelectItem><SelectItem value="M.Sc">M.Sc</SelectItem></SelectContent></Select><FormMessage /></FormItem>)} />
              ...
              <FormField control={form.control} name="affiliatedUniversity" render={({ field }) => (<FormItem><FormLabel>Affiliated University *</FormLabel><Select onValueChange={field.onChange} value={field.value}><FormControl><SelectTrigger><SelectValue /></SelectTrigger></FormControl><SelectContent><SelectItem value="Anna University">Anna University</SelectItem><SelectItem value="Madurai Kamaraj University">Madurai Kamaraj University</SelectItem><SelectItem value="Bharathidasan University">Bharathidasan University</SelectItem><SelectItem value="Bharathiar University">Bharathiar University</SelectItem></SelectContent></Select><FormMessage /></FormItem>)} />
            </div>
